...
ActiveRecord::Schema.define(version: 20150818191424) do
  ...
  add_index "dinings", ["restaurant_id", "user_id"], name: "index_dinings_on_restaurant_id_and_user_id", unique: true, using: :btree
